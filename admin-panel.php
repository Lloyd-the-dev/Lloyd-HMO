...
include('func.php');  
include('newfunc.php');
$con=mysqli_connect("localhost","root","oreoluwa2003","myhmsdb");
...
<html lang="en">
  <head>
    ...
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <link rel="shortcut icon" type="image/x-icon" href="images/enormico-hospital.png" />
                  ...
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <p class="links cl-effect-1">
                        <a href="book-appointment.php" onclick="clickDiv('#list-home-list')">
                          Book Appointment
                        </a>
                      </p>
                    </div>
